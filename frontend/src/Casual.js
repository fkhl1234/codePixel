...
export default function Casual() {
    ...
    return (
        <div className="casual">
            <div className="casual-codeConsole main-rectangle">
                <div className='flex-row'>
                    <p className='main-text main-title'>codePixel</p>
                    <div className='casual-buttonSet'>
                ...
                <div className='casual-codeArea'>
                    <CodeMirror className="casual-codeMirror"
                        value={code}
            ...
            <div className="casual-display main-rectangle">
                <canvas
                    ref={canvasRef}
                    width={pixelFixed}
                    height={pixelFixed}
